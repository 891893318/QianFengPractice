...
query = "SELECT DISTINCT s_name FROM images_table "
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if confidence < 45:
            ...
            sql = "SELECT DISTINCT image_id,s_name,sex,age,student_id,college FROM images_table WHERE image_id = %s"
            val = (img_id,)
            print(val)          # 查看数据
        ...
        text_bbox = draw.textbbox((1, 4), text, font=font)
